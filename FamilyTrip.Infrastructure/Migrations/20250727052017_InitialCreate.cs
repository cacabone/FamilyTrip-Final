        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PackingList_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackingList_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParticipatingTripsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripParticipants", x => new { x.ParticipantsId, x.ParticipatingTripsId });
                    table.ForeignKey(
                        name: "FK_TripParticipants_Trips_ParticipatingTripsId",
                        column: x => x.ParticipatingTripsId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TripParticipants_Users_ParticipantsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItineraryItems_Itinerary_ItineraryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackingList_TripId",
                table: "PackingList",
                column: "TripId");

            migrationBuilder.CreateIndex(
                name: "IX_PackingList_UserId",
                table: "PackingList",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TripParticipants_ParticipatingTripsId",
